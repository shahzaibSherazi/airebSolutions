      ...
      <div className="w-full px-8 py-[8vh] sm:py-[10vh] lg:py-[12vh]">
        <div className="w-full flex flex-col lg:flex-row items-center lg:items-start justify-between gap-[6vh] lg:gap-[4vw] xl:gap-[6vw]">
          ...
          <div
            ...
            <h1 className="font-stoke font-normal w-full block text-[clamp(28px,5vw,52px)] leading-[1.28] tracking-[0px] text-white">
              Effortless Data Flow <br className="lg:block hidden" /> with
              Custom API Development <br className="lg:block hidden" /> Services
            </h1>
