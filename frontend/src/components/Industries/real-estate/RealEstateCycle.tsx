...
//         height: size,
//       }}>
//       <div className=" flex flex-1 flex-col items-center justify-center text-center gap-3 group-hover:bg-primary bg-[#0E1828]">
//         {icon}
...
//   const totalW = STUB + innerW + STUB;

//   const rowH = C;
//   const bridgeH = 130;
//   const svgH = rowH + bridgeH + rowH;
...
//   return (
//     <section className="w-full bg-[#02070F] py-[60px] px-5 box-border font-outfit">
//       <div className="">
//         {/* Header */}
//         <div className="text-center mb-[52px]">
//           <h1 className="text-white font-bold leading-tight mb-4 mt-0 font-stoke text-[clamp(36px,4vw,42px)]">
//             Our Real Estate Development Cycle
//           </h1>
//           <p className="text-textColor font-outfit text-[clamp(14px,1.5vw,16px)] leading-[1.7] ">
//             Our structured development cycle ensures the successful delivery of
//             real estate solutions that meet <br className="hidden lg:block" />{" "}
//             your business needs, improve client engagement, and enhance
//             operational efficiency.
//           </p>
//         </div>

//         {/* SVG + Cards container */}
//         <div className="relative w-full mx-auto" style={{ maxWidth: totalW }}>
//           {/* SVG connector lines */}
//           <svg
...
//             <defs>
//               {/* visible → invisible(center) → visible */}
//               <linearGradient
//                 id="vGradLeft"
//                 x1="0"
//                 y1={topY}
...
//             {/* LEFT vertical — gradient: visible→gap→visible */}
//             <line
//               x1={xLeft}
//               y1={topY}
//               x2={xLeft}
...
//             {/* RIGHT vertical — gradient: visible→gap→visible */}
//             <line
//               x1={xRight}
//               y1={topY}
//               x2={xRight}
...
//           {/* Description text in bridge area */}
//           <div
//             className="absolute flex items-center justify-center"
//             style={{ left: STUB, right: STUB, top: rowH, height: bridgeH }}>
//             <p className="text-textColor font-outfit text-[clamp(14px,1.5vw,16px)] font-normal leading-[1.75]  m-0 text-center">
//               We start by understanding your real estate business, objectives,
//               and target audience. This allows us to craft a <br /> customized
//               strategy tailored to your needs and market challenges.
//             </p>
//           </div>

//           {/* ROW 2 cards */}
//           <div className="absolute" style={{ left: STUB, top: rowH + bridgeH }}>
//             <Card
//               icon={<TestingIcon />}
...
//           {/* Spacer for correct container height */}
        ...
        <div
          ...
          <div
            ...
            <div
              ...
              <p className="text-textColor font-outfit text-[clamp(14px,1.5vw,16px)] font-normal leading-[1.75] m-0 text-center">
                We start by understanding your real estate business, objectives,
                and target audience. This allows us to craft a <br />
                customized strategy tailored to your needs and market
                challenges.
              </p>
            </div>
