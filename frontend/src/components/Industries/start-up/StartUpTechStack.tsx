...
import teckStackImg from "@/assets/Industies/telecommunication/techStack-img.png";
const techStack = [
  {
    name: "Node.Js",
    icon: (
...
export default function StartUpTechStack() {
  return (
    <>
        ...
        <div className="container px-6 sm:px-8  py-16 md:py-24">
          ...
          <div className="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-6 mb-10 md:mb-14">
            ...
            <div className="flex-shrink-0 sm:pt-2">
              <a
                href="#contact-form"
                className="group w-fit flex items-center gap-3 border border-primary  hover:bg-[#1d4ed8] text-white text-sm lg:text-lg font-bold px-6 py-3 rounded-[9px] transition-all duration-200 hover:shadow-[0_0_20px_rgba(37,99,235,0.4)] hover:-translate-y-0.5"
                style={{
                  background:
          ...
          <div className="flex flex-col md:flex-row gap-5  ">
            ...
            <div
              ...
              style={{
                background: "linear-gradient(180deg, #750359 0%, #000000 100%)",
              }}>
              {/* Bottom text + button */}
              <div className="flex flex-col justify-center items-start gap-4">
                ...
                <button
                  ...
                  className="group flex items-center font-outfit font-bold gap-2  hover:text-black text-white text-sm  px-4 py-2.5 rounded-full transition-all duration-200 border border-primary">
                  Start A Project
