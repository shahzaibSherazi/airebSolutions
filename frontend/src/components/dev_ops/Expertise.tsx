          ...
          {features.map((feature) => (
            <div
              ...
              <div className="relative z-10 flex-1 flex flex-col">
                ...
                <h3 className="text-white font-outfit text-title font-normal leading-[1.3] mb-2 pr-8 line-clamp-2">
                  {feature.title}
                </h3>
                <p className="text-white font-outfit text-p line-clamp-2 leading-[1.3] overflow-hidden pr-8">
                  {feature.desc}
                </p>
              </div>
