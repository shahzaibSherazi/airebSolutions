  ...
  return (
    <footer
      ...
      <div className="container pt-16 lg:pt-24 pb-10 lg:px-8 px-2">
        ...
        {/* ── Bottom section ─────────────────────────────────────────────────── */}
        <div className=" pt-10 lg:pb-24 pb-16 overflow-hidden">
            ...
            <div className="relative">
              ...
              <div className="relative flex flex-col gap-3">
                ...
                <p className="text-textColor font-outfit text-sm leading-relaxed max-w-[290px]">
                  Aireb Solutions empowers businesses with innovative fintech
                  and AI-driven services. From CRM integrations to digital
                  content and automation, we tailor solutions that drive growth.
                </p>
              </div>
            </div>
