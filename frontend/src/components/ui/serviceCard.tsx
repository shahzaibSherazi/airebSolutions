...
const ServiceCard = ({ image, title, link, gradient }) => {
  return (
    <div className="card relative w-full bg-gradient-to-t from-black to-primary  max-w-[403px] h-[400px] sm:h-[490px]  border border-primary flex flex-col gap-2 sm:gap-4 p-2 sm:p-3 overflow-hidden snap-center mx-auto shrink-0">
