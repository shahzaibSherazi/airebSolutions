          ...
          {features.map((feature) => (
            <div
              ...
              <div className="relative z-10 flex-1 flex flex-col justify-center">
                ...
                <h1 className="text-primary text-center group-hover:text-textColor font-outfit text-sm sm:text-lg md:text-xl font-normal leading-[1.3] pr-8 line-clamp-2 mb-3 ">
                  {feature.heading}
                </h1>
              </div>
