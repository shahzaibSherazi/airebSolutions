...
//           <button className="relative bg-primary font-outfit font-medium text-white px-6 sm:px-8 py-2 sm:py-2.5 text-xs sm:text-[22px] hover:bg-blue-700 transition-colors">
//             Our Reviews
...
//                     {/* Quote Icon */}
//                     <div className="text-base sm:text-4xl  md:text-5xl lg:text-6xl  text-white font-outfit font-normal">
//                       <span className="tracking-[0px]">
//                         {" "}
//                         &#x275B; &#x275B;{" "}
//                       </span>
//                     </div>
          ...
          <div className="w-full max-w-[1006px] mx-auto perspective-1000">
            <div
              ...
              style={{
                ...
                animation:
                  direction === 1
                    ? "cardSlideRotateRight 0.7s cubic-bezier(0.34, 1.56, 0.64, 1)"
                    : direction === -1
