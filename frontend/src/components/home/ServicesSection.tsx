...
//                 <button
//                   type="button"
//                   className="group flex items-center text-black font-outfit gap-2 sm:gap-3 md:gap-4 bg-primary px-3 sm:px-4 md:px-4 py-2 md:py-2 text-xs sm:text-sm md:text-base font-medium tracking-wide transition whitespace-nowrap">
//                   View All Services
//                   <span className="bg-white w-8 h-8 sm:w-10 sm:h-10 md:w-11 md:h-11 text-black flex items-center justify-center transition group-hover:translate-x-1 flex-shrink-0">
