...
const ResultSection = () => {
  ...
  return (
    <section ref={sectionRef} className="bg-primary w-full ">
      {/* Header */}
      <div className="container flex flex-col py-16 lg:py-24 items-center">
        <div className="flex flex-col lg:flex-row justify-between items-center gap-3 lg:gap-0 w-full ">
          <div className="flex flex-col lg:items-start items-center md:gap-[30px] gap-[7px] w-full lg:w-1/3">
            <h1 className="text-xl font-normal text-white">Results</h1>
            <p className="text-h2 font-stoke lg:text-white text-black">
              Impact you can feel
            </p>
          </div>
          <p className="text-white lg:text-start text-center text-md font-normal font-outfit leading-[28px] lg:w-1/3">
          ...
          <Link
            to="/about-us"
            className="group flex lg:justify-end items-center gap-2 text-textColor bg-black text-xs sm:text-sm font-medium px-[21px] py-[18px] hover:bg-white hover:text-black transition whitespace-nowrap">
            Read More About Us
        ...
        <div className="flex flex-col sm:flex-row gap-6 md:pt-[50px] pt-[56px] lg:gap-12 w-full">
          <div className="flex flex-col items-center sm:flex-1 gap-2">
            ...
            <p className="text-textColor font-outfit  text-md text-center">
              Clients who stay because we consistently deliver results
            </p>
          </div>

          <div className="flex flex-col items-center sm:flex-1 gap-2 lg:border-l-2 lg:pl-4 border-textColor">
            <p className="text-black font-normal text-[24px] sm:text-[42px]">
              {counts.count45}%
            </p>
            <p className="text-textColor text-md font-outfit text-center">
