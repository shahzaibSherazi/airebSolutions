...
BRANDS, PRODUCTS, AND DIGITAL EXPERIENCES
    ...
    opacity-100 uppercase">
          ...
          <div className="mt-24 flex justify-center">
            <button style={{paddingLeft:14}} className="group flex items-center  gap-4 bg-[#0B23C8] px-1 py-1 text-lg tracking-wide hover:bg-blue-700 transition">
              Get Started
